export const COPY = {
  en: {
    ...
    catalogEmpty: "No subscriptions yet. Check back soon.",
    ...
    adminExportCatalog: "Export catalog",
    adminImportCatalog: "Import catalog",
    adminExportDone: "Catalog downloaded as admin-state.json.",
    adminImportDone: "Catalog restored from admin-state.json.",
    adminImportConfirm:
      "Replace the live catalog with this admin-state.json? Offers and prices in the file will go live immediately.",
    ...
    adminOfferType: "Offer Type (optional)",
    adminOfferNone: "None — regular service",
    adminOfferExpires: "Offer expiry date and time",
    adminOfferHint:
      "Offers are optional. An expired offer is hidden from the store but remains here in Admin so you can edit or delete it.",
    offerEid: "Eid Offer",
    offerSpecial: "Special Offer",
    offerEndsIn: "Ends in",
    offerDaysShort: "d ",
    offerExpiredAdmin: "Expired offer (hidden on store)",
  ...
  ar: {
    ...
    catalogEmpty: "لا توجد اشتراكات حالياً. ترقّبونا قريباً.",
    ...
    adminExportCatalog: "تصدير الكتالوج",
    adminImportCatalog: "استيراد الكتالوج",
    adminExportDone: "تم تنزيل الكتالوج كملف admin-state.json.",
    adminImportDone: "تم استعادة الكتالوج من admin-state.json.",
    adminImportConfirm:
      "هل تريد استبدال الكتالوج الحالي بهذا الملف؟ ستظهر العروض والأسعار الموجودة في الملف فوراً.",
    ...
    adminOfferType: "نوع العرض (اختياري)",
    adminOfferNone: "بدون — خدمة عادية",
    adminOfferExpires: "تاريخ ووقت انتهاء العرض",
    adminOfferHint:
      "العروض اختيارية. العرض المنتهي يختفي من المتجر ويبقى هنا في لوحة الإدارة لتعديله أو حذفه.",
    offerEid: "عرض العيد",
    offerSpecial: "عرض خاص",
    offerEndsIn: "ينتهي خلال",
    offerDaysShort: "ي ",
    offerExpiredAdmin: "عرض منتهٍ (مخفي في المتجر)",
